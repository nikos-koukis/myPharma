...
export const translations = {
    el: {
        ...
        no_pharmacies_found: 'Δεν βρέθηκαν αποτελέσματα',
        ...
        opening_later: 'Ανοίγουν αργότερα',
        ...
        no_opening_later: 'Δεν βρέθηκαν φαρμακεία που ανοίγουν αργότερα',
        no_results: 'Δεν βρέθηκαν αποτελέσματα',
        try_different_filter: 'Δοκιμάστε διαφορετικό φίλτρο',
        is_open: 'είναι ανοιχτά',
        are_opening_later: 'ανοίγουν αργότερα',
    ...
    en: {
        ...
        no_pharmacies_found: 'No results found',
        ...
        no_opening_later: 'No pharmacies opening later',
        no_results: 'No results found',
        try_different_filter: 'Try a different filter',
        is_open: 'are open',
        are_opening_later: 'opening later',
        are_on_duty: 'on duty',
